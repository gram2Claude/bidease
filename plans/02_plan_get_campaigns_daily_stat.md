...
> 2026-07-27 схема расходов изменена: `_vat_multiplier` удалён, рублёвые
> `costs_*`-поля и `ak` убраны, расход — одно поле `costs_usd` ← `spend`.
> Актуальный контракт — спека 02 и `info/01_functions_implemented.md`.
